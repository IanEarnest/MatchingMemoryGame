    ...
    public partial class Form1 :Form
    {
        ...
        private void AssignIconsToSquares()
        {
            ...
            foreach (Control control in tableLayoutPanel1.Controls)
            {
                ...
                if (iconLabel != null)
                {
                    ...
                    iconLabel.ForeColor = iconLabel.BackColor; // set invisible
        ...
        private void label_Click(object sender, EventArgs e)
        {
            ...
            if (clickedLabel != null)
            {
                ...
                if (firstClicked.Text != null && secondClicked.Text != null && thirdClicked.Text != null)
                {
                    if (firstClicked.Text != secondClicked.Text ||
                        secondClicked.Text != thirdClicked.Text)
                    {
                        firstClicked.ForeColor = this.BackColor;
                        secondClicked.ForeColor = this.BackColor;
                        thirdClicked.ForeColor = this.BackColor;
                        firstClicked = null;
                        secondClicked = null;
                        thirdClicked = null;
                        return;
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            thirdClicked.ForeColor = thirdClicked.BackColor;
